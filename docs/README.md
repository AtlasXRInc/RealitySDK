# RealitySDK – Beyond Sandbox Modkit

RealitySDK is the official modding SDK for *Beyond Sandbox*, a multiplayer VR sandbox platform powered by Unreal Engine 5.
...
Follow the official guide to install the modkit and set up your development environment:
